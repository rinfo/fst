...
FST_ORG_CONTACT_NAME = u"Johan Exempelson"
...
FST_DATASET_URI = "tag:exfs.se,2009:rinfo:feed"
FST_DATASET_TITLE = u"Flöde för Exempelmyndighetens författningssamling"

# Use secret key below as site ID and don't share it with anybody
SECRET_KEY = 'nlxvlipuqtijgspzhlsxxlpctjrkxdkulxmxupgrutvdytbmjl'